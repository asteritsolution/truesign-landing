<footer id="footer" class="border-0 mt-0" style="background-color: #f2f2f2;">
      <div class="container">
        <div class="footer-widgets-wrap pb-md-4 clearfix">
          <div class="row">
            ...
            <div class="col-lg-12 justify text-black-50 mt-4">
              <p class="ls0 nott" style="font-size: small; text-align: justify;">At True Sign Publication we always
