<footer id="footer" class="border-0 mt-0" style="background-color: #388977;">
  <div class="container">
    <div class="footer-widgets-wrap pb-md-4 clearfix">
      <div class="row">
        <div class="col-lg-2 col-md-2 col-6">
          <div class="widget clearfix">
            <h4 class="ls0 mb-4 nott">Self Publishing</h4>
            <ul class="list-unstyled iconlist ml-0">
              <li class="mb-2"><a href="how-to-publish-a-book">How To Publish</a></li>
              <li class="mb-2"><a href="services">Services</a></li>
              <li class="mb-2"><a href="pricing">Pricing</a></li>
              <li class="mb-2"><a href="calculate/author-royalty">Calculate Royalty</a></li>
            </ul>
          </div>
        </div>
        <div class="col-lg-2 col-md-2 col-6">
          <div class="widget clearfix">
            <h4 class="ls0 mb-4 nott">Author Support</h4>
            <ul class="list-unstyled iconlist ml-0">
              <li class="mb-2"><a href="registration/new-author" title="New Author">New Author</a></li>
              <li class="mb-2"><a href="frequently-asked-questions">FAQs</a></li>
              <li class="mb-2"><a href="publishing-process">Publishing Process</a></li>
...
Near UCO Bank, Bhopal, Madhya Pradesh - 462039
        ...
        <div class="col-lg-12 justify text-black-50 mt-4">
          <p class="ls0 nott" style="font-size: small; text-align: justify; color:#fff;">At True Sign Publication we always
            believes in giving chance to emerging authors to publish their books completely, get it available
            worldwide and live their dreams. We believes in supporting the dreams of young eyes who wishes of being
            published. Currently we have one of the largest book distribution network in the world for paperback and
            eBooks. Most promising self-publishing company in India​. We provide you the platform, independence, and
            flexibility to create and share what you love and feel with the entire world through book publishing.
          </p>
        </div>
      </div>
    </div>
